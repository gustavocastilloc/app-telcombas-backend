 ...
 * @author Carolina
 */
public class OrionFacade {
    
    private Conexion con;

    public OrionFacade(Conexion con) {
        this.con = con;
    }

    public JSONArray obtenerListado(Orion dato) {
    ...
    public Integer obtenerListadoSize(Orion dato) {
        String query
                = "SELECT COUNT(id)\n"
                + "FROM Orion\n"
                + "WHERE nombre LIKE '%" + dato.getNombre().trim() + "%' and estado = " + dato.getEstado() + ";";
    ...
    public JSONArray busquedaId(Orion dato) {
        JSONArray lista = null;
        JSONParser parser = new JSONParser();
        String query
                = "SELECT *\n"
    ...
    public JSONArray busquedaNombre(Orion dato) {
        JSONArray lista = null;
        JSONParser parser = new JSONParser();
        String query
                = "SELECT id,nombre\n"
    ...
    public boolean actualizar(Orion dato) {
        String query
                = "UPDATE Orion\n"
    ...
    public boolean crear(Orion dato) {
        String query
                = "INSERT INTO Orion\n"
                + "           (id\n"
                + "           ,nombre)\n"
