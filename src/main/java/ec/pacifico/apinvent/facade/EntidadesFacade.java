 ...
 * @author Carolina
 */
public class EntidadesFacade {
   private Conexion con;

    public EntidadesFacade(Conexion con) {
        this.con = con;
    }

    public JSONArray obtenerListado(Entidades dato) {
    ...
    public Integer obtenerListadoSize(Entidades dato) {
        String query
                = "SELECT COUNT(id)\n"
                + "FROM Entidades\n"
                + "WHERE nombre LIKE '%" + dato.getNombre().trim() + "%' and estado = " + dato.getEstado() + ";";
    ...
    public JSONArray busquedaId(Entidades dato) {
        JSONArray lista = null;
        JSONParser parser = new JSONParser();
        String query
                = "SELECT *\n"
    ...
    public JSONArray busquedaNombre(Entidades dato) {
        JSONArray lista = null;
        JSONParser parser = new JSONParser();
        String query
                = "SELECT id, nombre\n"
    ...
    public boolean actualizar(Entidades dato) {
        String query
                = "UPDATE Entidades\n"
    ...
    public boolean crear(Entidades dato) {
        String query
                = "INSERT INTO Entidades\n"
                + "           (id\n"
                + "           ,nombre)\n"
                + "     VALUES\n"
                + "           (NEXT VALUE FOR SeqEntidades\n"
                + "           ,'" +dato.getNombre().trim() + "')";
        PreparedStatement st = null;
        ResultSet rs = null;
        try {
