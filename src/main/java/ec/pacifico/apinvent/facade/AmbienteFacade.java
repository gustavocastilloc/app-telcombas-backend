...
public class AmbienteFacade {
    ...
    public AmbienteFacade(Conexion con) {
        this.con = con;
    }

    public JSONArray obtenerListado(Ambiente dato) {
    ...
    public Integer obtenerListadoSize(Ambiente dato) {
        String query
                = "SELECT COUNT(id)\n"
                + "FROM Ambiente\n"
                + "WHERE nombre LIKE '%" + dato.getNombre().trim() + "%' and estado = " + dato.getEstado() + ";";
    ...
    public JSONArray busquedaId(Ambiente dato) {
        JSONArray lista = null;
        JSONParser parser = new JSONParser();
        String query
                = "SELECT *\n"
    ...
    public JSONArray busquedaNombre(Ambiente dato) {
        JSONArray lista = null;
        JSONParser parser = new JSONParser();
        String query
                = "SELECT id, nombre\n"
    ...
    public boolean actualizar(Ambiente dato) {
        String query
                = "UPDATE Ambiente\n"
    ...
    public boolean crear(Ambiente dato) {
        String query
